...
\begin{nota}
  ...
  songbook lui-même (\refsec{sec:songbook-dep}). Pour que tous les
  éléments de l'interface fonctionnent, les dépendances recommandées
  sont \emph{fortement} recommandées.
\end{nota}
...
%*******************************************************************************
\section{Installation depuis le paquet Debian}
%*******************************************************************************
...
\begin{unixcom}
  cd $HOME
  wget http://www.patacrep.com/data/documents/songbook-client_0.3.2-1_amd64.deb
  sudo dpkg -i songbook-client_0.3.2-1_amd64.deb
\end{unixcom}
%$
