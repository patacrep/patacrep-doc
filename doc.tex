...
\paragraph{Dépendances optionnelles}
\begin{verbatim}
...
seul fichier pdf. À la place de \emph{book.pdf}, vous pouvez mettre:
\begin{itemize}
\item chordbook.pdf
\item lyricbook.pdf
...
\item d'indiquer le chemin du songbook dans les préférences (par
  ...
  contenir le makefile et le répertooire songs/ contenant les chansons
  disponibles;
...
l'interface. Vérifiez que votre sytème dispose bien du support qt de sqlite.

\paragraph{Pas de partitions}
Si la compilation de votre recueil de chansons n'intègre pas les
partitions lilypond malgré l'option \emph{Lilypond} correctement cochée dans les
...
patacrep songbook est correctement renseigné dans Edition/Préférences.
...
Si vous prévoyez de faire beacoup de modifications ou de rejoindre
activement le développement du songbook, le sytème de patch n'est pas
...
la partager. Des solutions web gratuites permettent d'héberger de tels
projets. Par exemple:
\begin{itemize}
...
façon à ce que nous puissions récupérer vos changements que l'on
trouvera intéressants.
...
Lilypond est généralement packagé pour les distributions
