...
\begin{nota}
  Les fichiers \collarg{make.bat} et \colarg{make.jar} sont
  disponibles dans l'archive songbook-winds.zip:
...
\todo{reprendre avec le systeme de templates}
...
\begin{nota}
  ...
  \voir{sec:songbook-dep}{correspnodante}). Pour que tous les éléments
...
\latexcom{beginverse*} permettant de ne pas numéroter le couplet.
